...
- **12,240 flakes** in the index, from **12,411 in the library tier** (171 could not be pinned, 0 not yet pinned)
- 1,196 ship no usable lock file and use one computed by Nix
