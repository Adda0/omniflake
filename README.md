...
- **16,006 flakes** in the index, from **16,223 in the library tier** (217 could not be pinned, 0 not yet pinned)
- 1,608 ship no usable lock file and use one computed by Nix
