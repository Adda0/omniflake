...
- **16,003 flakes** in the index, from **16,221 in the library tier** (218 could not be pinned, 0 not yet pinned)
- 1,607 ship no usable lock file and use one computed by Nix
